...
CATALOG: dict[str, list[tuple[str, str, str, str, str, str, str]]] = {
    ...
    "G_AdminBFF_DocUtil": [
        ...
        ("G-04a", "dashboard anonymous [트랙 #75 보정]", "-", "GET /api/admin/docutil/dashboard/metrics (+ response-times, search-errors, search-usage, upload-status)", "401", "안전", "YES"),
        ("G-04b", "dashboard admin read [트랙 #75 보정]", "admin JWT", "GET /api/admin/docutil/dashboard/metrics 외 4개", "200/404/502", "중간", "YES"),
        ...
        ("G-07a", "evaluation anonymous [트랙 #75 보정]", "-", "GET /api/admin/docutil/evaluation/config", "401", "안전", "YES"),
        ("G-07b", "evaluation admin read [트랙 #75 보정]", "admin JWT", "GET /api/admin/docutil/evaluation/config", "200/404/502", "중간", "YES"),
